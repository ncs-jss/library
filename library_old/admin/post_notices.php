                            ...
                            <div class="col-sm-8 form-query">
                                ...
                                <form action="notice.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="subject" value="<?php if(isset($_SESSION['subject']))echo $_SESSION['subject']?>" name="subject"  placeholder="Subject:"><span class="error"><?php if(isset($_SESSION['subjectErr']))echo $_SESSION['subjectErr'];?></span>
                                    </div>
