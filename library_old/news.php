                            ...
                            <table class="table table-striped table-row " id="data">
								...
								<?php 
									if(isset($_REQUEST['search']))
									{
										while($i<$count) {?>
										<?php 
										if(strcmp($_REQUEST['search'],$rownewsfetched[$i]['news'])==0)
										{
										?>
                                    <tr>
                                        <th scope="row"><?php echo $i+1 ?></th>
                                        
                                        <td><?php echo $rownewsfetched[$i]['news']?> </td>
                                        <td><?php echo $rownewsfetched[$i]['details']?> </td>
                                        <td><?php echo $rownewsfetched[$i]['date_posted']?> </td>
                                        <?php if ($flag==1) {
                                        $s=$rownewsfetched[$i]['id'];
