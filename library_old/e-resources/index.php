		...
		<script type="text/javascript">
						...
						while($i<$count) {
							?>
								...
								function text<?php echo $rowarrivalsfetched[$i]['id'];?>()
											{

													document.getElementById('<?php echo $rowarrivalsfetched[$i]["id"];?>').innerHTML = "<input style = 'display:block' type ='text' size='30' value='<?php echo $rowarrivalsfetched[$i]['name'];?>'/><input style = 'display:block' type='text' size='30' value='<?php echo $rowarrivalsfetched[$i]['url']?>'/>"
				...
				<div class="row">
					...
					<div class="col-sm-8 col-xs-9">
						...
						while($i<$count) {
							if($flag==1)
							{
							?>			<form action="edit.php" name="query">

							<?php }?>

										<li id="<?php echo $rowarrivalsfetched[$i]['id'];?>"><a href="<?php echo $rowarrivalsfetched[$i]['url']; ?>"><?php echo $rowarrivalsfetched[$i]['name']; ?></a><p><?php echo $rowarrivalsfetched[$i]['url']; ?></p></li> 
								   <?php
								   if($flag==1)
								   {

									echo "<button type='submit' id='t' style='display:none' class='btn btn-primary fa'>Save</button>";

									echo "</form>";
									echo "<button onClick='text".$rowarrivalsfetched[$i]['id']."()' id='toggle' class='btn btn-primary fa fa-pencil'></button>";
									echo "<button class='btn btn-primary fa fa-trash'></button>";
