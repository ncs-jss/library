...
$rowarrivalsfetched=display_arrivals();
            ...
            <div class="container-fluid">
                ...
                <div class="row content">
                    ...
                    <div class="col-sm-8 col-xs-9">
                        ...
                        <div class="row">
                        <form action="delete_arrivals.php" method="post">
                            <table class="table table-striped table-row " id="data">
								...
								<?php 
									if(isset($_REQUEST['search']))
									{
										while($i<$count) {?>
										<?php 
										if(strcmp($_REQUEST['search'],$rowarrivalsfetched[$i]['title'])==0)
										{
										?>
                                    <tr>
                                        <th scope="row"><?php echo $i+1 ?></th>
                                        
                                        <td><?php echo $rowarrivalsfetched[$i]['title']?> </td>
                                        <td><?php echo $rowarrivalsfetched[$i]['details']?> </td>
                                        <td><?php echo $rowarrivalsfetched[$i]['date_of_arrival']?> </td>
                                        <?php if ($flag==1) {
                                        $s=$rowarrivalsfetched[$i]['id'];
