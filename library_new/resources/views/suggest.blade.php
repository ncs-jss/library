                            ...
                            <div class="col-xs-12 col-sm-8 form-query">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="Title of the book">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">Author:</label>
                                        <input type="text" class="form-control" id="" placeholder="Author's Name">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">Publisher</label>
                                        <input type="text" class="form-control" id="" placeholder="Publisher's Name">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">Edition</label>
                                        <input type="text" class="form-control" id="" placeholder="Edition">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">Volume</label>
                                        <input type="text" class="form-control" id="" placeholder="Volume">
                                    </div>
                                    <div class="form-group">
