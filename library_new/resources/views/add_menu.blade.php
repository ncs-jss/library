                  ...
                  <!-- Side Space -->
                    ...
                    <div class=" col-xs-10 col-sm-8 col-sm-pull-2">
                        ...
                        <div class="row " id="add-menu-item">
                            ...
                            <h2 style="text-align:left">Add Menu Item</h2>
                            <div class='container-fluid '>
                              <div class="row">
                                  ...
                                  <div class="col-xs-12 col-sm-6 ">
                                      <form action="new_menu" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="" name="menu_name" placeholder="Menu Name *" required>
                                        </div>
                                        <div class="form-group">
                                          <label class="sr-only">Content:</label>
                                            <textarea name="content" placeholder="Editor" id="editor" rows="10" cols="80"></textarea>
                                        </div>
